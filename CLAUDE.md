...
**Все 4 фазы плана (A-D) сделаны.** Продукт работает вживую в Telegram (бот
Addict Film). Дальше — по запросу: UX-полировка, деплой (постоянный домен +
Cloudflare Tunnel), опциональный бот для уведомлений, платный тариф kinopoisk.
Роадмап — в README.md.
